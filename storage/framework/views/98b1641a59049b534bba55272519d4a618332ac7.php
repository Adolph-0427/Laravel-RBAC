...
<head>
  ...
  ================================================== -->
    ...
    <!-- CSS
  ================================================== -->
    <link rel="stylesheet" href="<?php echo e(URL::asset('/front/css/zerogrid.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::asset('/front/css/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::asset('/front/css/responsive.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::asset('/front/css/responsiveslides.css')); ?>">
    ...
    <link href="<?php echo e(URL::asset('/front/images/favicon.ico')); ?>" rel='icon' type='image/x-icon'/>

    <script src="<?php echo e(URL::asset('/front/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('/front/js/responsiveslides.js')); ?>"></script>
    <script>
        $(function () {
...
<div class="container">
    <!--------------Header--------------->
    <header>
        <div id="logo"><a href=""><img src="<?php echo e(URL::asset('/front/images/logo.png')); ?>"/></a></div>
        <nav>
            <ul class="menu">
                <?php $__env->startSection('pc_menu'); ?>
            ...
            <div class="minimenu">
                <div>MENU</div>
                <select>
                    <?php $__env->startSection('app_menu'); ?>
                        <option>Home</option>
                        <option>Blog</option>
        ...
        <div class="feature">
            <div class="rslides_container">
                <ul class="rslides" id="slider">
                    <li><img src="<?php echo e(URL::asset('/front/images/1.jpg')); ?>"/></li>
                    <li><img src="<?php echo e(URL::asset('/front/images/2.jpg')); ?>"/></li>
                    <li><img src="<?php echo e(URL::asset('/front/images/3.jpg')); ?>"/></li>
                    <li><img src="<?php echo e(URL::asset('/front/images/4.jpg')); ?>"/></li>
                </ul>
            </div>
        </div>
    <?php echo $__env->yieldSection(); ?>
                ...
                <div class="row">
                    ...
                    <section class="col-1-3">
                        ...
                        <div class="content">
                            <table border="0px">
                                <tr>
                                    <td><img src="<?php echo e(URL::asset('/front/images/thumb5.jpg')); ?>"/></td>
                                    <td><img src="<?php echo e(URL::asset('/front/images/thumb6.jpg')); ?>"/></td>
                                    <td><img src="<?php echo e(URL::asset('/front/images/thumb7.jpg')); ?>"/></td>
                                </tr>
                                <tr>
                                    <td><img src="<?php echo e(URL::asset('/front/images/thumb6.jpg')); ?>"/></td>
                                    <td><img src="<?php echo e(URL::asset('/front/images/thumb7.jpg')); ?>"/></td>
