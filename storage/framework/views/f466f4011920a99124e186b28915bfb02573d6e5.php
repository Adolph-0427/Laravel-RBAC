                        ...
                        <form class="form-horizontal" method="post" action="<?php echo e(url('menu')); ?>" name="basic_validate" id="basic_validate" novalidate="novalidate">
                            ...
                            <?php if(!empty($parent->id)): ?>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="name" value="<?php echo e($parent->name); ?>" disabled>      <a></a>
                                    </div>
                                    <input type="hidden" name="pid" value="<?php echo e($parent->id); ?>">
                                </div>
                            <?php endif; ?>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="route" class="required">
                                </div>
                            </div>
