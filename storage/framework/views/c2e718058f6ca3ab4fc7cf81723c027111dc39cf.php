...
<?php $__env->startSection('css'); ?>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/froala-editor/2.8.4/css/froala_editor.pkgd.min.css"
          rel="stylesheet" type="text/css"/>
    <link href="https://cdnjs.cloudflare.com/ajax/libs/froala-editor/2.8.4/css/froala_style.min.css"
          rel="stylesheet" type="text/css"/>
                                ...
                                <div class="controls">
                                    <div data-date="12-02-2012"
                                        ...
                                        <input type="text"
                                               ...
                                               class="date-picker" data-date-format="mm-dd-yyyy"
                                               class="span11">
...
<?php $__env->stopSection(); ?> <?php $__env->startSection('js'); ?>
    ...
    <script src="https://cdn.bootcss.com/froala-editor/2.8.1/js/languages/zh_cn.js"
    ...
    <script>
        $(function () {
            $('#edit').froalaEditor({
                ...
                imageUploadURL: "uploadImgEditor",//上传图片路径
